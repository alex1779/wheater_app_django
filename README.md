...
- [📖 Weather app with Django ](#-weather-app-)
...
**Weather app Using Django** A weather app in Django that gets the current weathers for multiple cities. To do this, I'll use Python Requests to call the Open Weather Map API.
...
- Pretty printed: [Pretty printed](https://prettyprinted.com/)
